...
Route::middleware(['auth:sanctum', 'role:R2'])->group(function () {
    ...
    Route::post('/bookings/{id}/confirm', [DoctorBookingController::class, 'confirm']);
    Route::post('/bookings/{id}/cancel', [DoctorBookingController::class, 'cancel']);
    Route::post('/bookings/{id}/send-prescription', [DoctorBookingController::class, 'sendPrescription']);
